...
import com.cdac.dto.PassengerDetails;
...
public class BookingService {
	...
	public int bookFlight(BookingDetails bookingDetails) {
		...
		if(status.isStatus()) {
			...
			for(PassengerDetails passengerDetails : bookingDetails.getPassengers()) {
				Passenger passenger = new Passenger();
				BeanUtils.copyProperties(passengerDetails, passenger);
				//TODO: fix the gender value not getting copied
